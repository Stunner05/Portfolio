				...
				<div className="col-span-3 grid md:grid-cols-2 gap-4 mt-4">
					<div className="border border-white/20 rounded-lg p-6">
						...
						<p className="text-white/50 mb-6">
							I combine creativity with strategy, turning ideas into practical,
							elegant solutions. My process emphasizes planning, execution, and
							iteration to deliver results that make an impact.
						</p>
					...
					<div className="border border-white/20 rounded-lg p-6">
						...
						<p className="text-white/50 mb-4">
							My goal is to continuously improve my skills and stay updated with
							the latest industry trends. I am eager to take on challenging
							projects that allow me to grow as a developer and contribute to
